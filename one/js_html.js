 ...
 btn.addEventListener('click', (event) => {
     ...
     let  values = [];
      ...
      //  alert(values);
       ...
       function Q1(){
          if(values[0]=='descriptive' && values.length==1)
          return true;
          else return false;
       }
      ...
      function Q2(){
          if(values1[0]=='action' && values1.length==1)
          return true;
          else return false;
       }
      ...
      function Q3(){
          if(values2[0]=='size' && values2.length==1)
          return true;
          else return false;
       }
      ...
      function Q4(){
          if(values3[0]=='_blank' && values3[1]=='_top' && values3[2]=='_self' && values3.length==3)
          return true;
          else return false;
       }
      ...
      function Q5(){
          if(values4[0]=='<h1>' && values4.length==1)
          return true;
          else return false;
       }
...
//q6
      ...
      function Q6(){
          if(values5[0]=='<table>' && values5[1]=='<th>' && values5.length==2)
          return true;
          else return false;
       }
///q6
...
//q7
        ...
        function Q7(){
            if(values6[0]=='td' && values6.length==1)
            return true;
            else return false;
        }
///q7
...
//q8
    ...
    function Q8(){
        if(values7[0]=='<ol>' && values7[1]=='<ul>' && values7.length==2)
        return true;
        else return false;
    }
///q8
