 ...
 btn.addEventListener('click', (event) => {
     ...
     let  values = [];
      ...
      //  alert(values);
       ...
       function Q1(){
          if(values[0]=='software' && values.length==1)
          return true;
          else return false;
       }
      ...
      function Q2(){
          if(values1[0]=='alert()' && values1[1]=='console.log()'  && values1.length==2)
          return true;
          else return false;
       }
      ...
      function Q3(){
          if(values2[0]=='prompt()' && values2[1]=='confirm()' && values2.length==2)
          return true;
          else return false;
       }
      ...
      function Q4(){
          if(values3[0]=='the number you want' && values3.length==1)
          return true;
          else return false;
       }
      ...
      function Q5(){
          if(values4[0]=='<script>' && values4.length==1)
          return true;
          else return false;
       }
...
//q6
      ...
      function Q6(){
          if(values5[0]=='if' && values5[1]=='switch-case' && values5.length==2)
          return true;
          else return false;
       }
///q6
...
//q7
        ...
        function Q7(){
            if(values6[0]=='document.write()' && values6.length==1)
            return true;
            else return false;
        }
///q7
...
//q8
    ...
    function Q8(){
        if(values7[0]=='getElementById' && values7[1]=='getElementsByName' && values7[2]=='document.write' && values7.length==3)
        return true;
        else return false;
    }
///q8
