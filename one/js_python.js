 ...
 btn.addEventListener('click', (event) => {
     ...
     let  values = [];
      ...
      function Q2(){
          if(values1[0]=='every one' && values1.length==1)
          return true;
          else return false;
       }
      ...
      function Q3(){
          if(values2[0]=='only you' && values2.length==1)
          return true;
          else return false;
       }
      ...
      function Q4(){
          if(values3[0]=='$_REQUEST' && values3.length==1)
          return true;
          else return false;
       }
      ...
      function Q5(){
          if(values4[0]=='get' && values4.length==1)
          return true;
          else return false;
       }
...
//all
      ...
      {
      document.getElementById('h2').innerHTML=(`You got 5 Correct`);
